      ...
      <aside className="w-full md:w-64 bg-white dark:bg-slate-900 text-slate-800 dark:text-white flex-shrink-0 flex flex-col justify-between border-r border-slate-200 dark:border-slate-800">
        <div>
          ...
          <nav className="p-4 space-y-1">
            <Link href="/parent?tab=overview" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary">
            ...
            <Link href="/parent?tab=attendance" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary">
              <CheckSquare size={18} />
              <span>Child Attendance</span>
            </Link>
            <Link href="/parent?tab=results" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary">
              <Award size={18} />
              <span>Grades & Performance</span>
            </Link>
            <Link href="/parent?tab=fees" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary">
              <CreditCard size={18} />
              <span>Child Tuition Fees</span>
            </Link>
            <Link href="/parent?tab=notices" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary">
              <Bell size={18} />
