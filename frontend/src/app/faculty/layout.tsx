      ...
      <aside className="w-full md:w-64 md:h-screen bg-white dark:bg-slate-900 text-slate-800 dark:text-white flex-shrink-0 flex flex-col md:justify-between border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800 md:sticky md:top-0">
        <div className="flex flex-col w-full">
          ...
          <nav className="p-2 md:p-4 flex flex-row md:flex-col overflow-x-auto md:overflow-x-visible space-x-2 md:space-x-0 md:space-y-1 scrollbar-none">
            <Link href="/faculty?tab=overview" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary whitespace-nowrap flex-shrink-0">
            ...
            <Link href="/faculty?tab=homework" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary whitespace-nowrap flex-shrink-0">
              <ClipboardList size={18} />
              <span>Assign Homework</span>
            </Link>
            <Link href="/faculty?tab=lectures" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary whitespace-nowrap flex-shrink-0">
              <Video size={18} />
              <span>Publish Lectures</span>
            </Link>
            <Link href="/faculty?tab=papers" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary whitespace-nowrap flex-shrink-0">
              <FileText size={18} />
              <span>Upload Notes & PYQs</span>
            </Link>
            <Link href="/faculty?tab=attendance" className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium transition-colors text-slate-700 dark:text-slate-200 hover:text-primary whitespace-nowrap flex-shrink-0">
              <CheckSquare size={18} />
